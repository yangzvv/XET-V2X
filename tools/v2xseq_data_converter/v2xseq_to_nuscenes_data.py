...
def create_spd_infos_coop(root_path,
    ...
    for coop_data_info in tqdm(coop_data_infos):
        ...
        cam2ego_r, cam2ego_t = mul_matrix(cam2lidar_r, cam2lidar_t, Quaternion(info['lidar2ego_rotation']).rotation_matrix, np.array(info['lidar2ego_translation']))
        ...
        camera_type_inf = 'INFRASTRUCTURE_CAM_FRONT'
        ...
        inf_cam2veh_ego_r, inf_cam2veh_ego_t = mul_matrix(inf_cam2veh_lidar_r, inf_cam2veh_lidar_t, Quaternion(info['lidar2ego_rotation']).rotation_matrix, np.array(info['lidar2ego_translation']))
