...
point_cloud_range_inf = [-51.2, -51.2, -3.0, 51.2, 51.2, 5.0]
    ...
    pts_bbox_head=dict(
        ...
        transformer=dict(
            ...
            encoder=dict(
                ...
                use_lidar_calib_error_offset=False,
...
dataset_type = "XETV2XDataset"
data_root = "./datasets/V2X-Sim-full-v2v-delay/"
info_root = "./data/infos/V2X-Sim-full-v2v-delay/"
ann_file_train = info_root + f"nuscenes_infos_temporal_train_new_v2v_valid.pkl"
ann_file_val = info_root + f"nuscenes_infos_temporal_val_new_v2v_valid.pkl"
ann_file_test = info_root + f"nuscenes_infos_temporal_val_new_v2v_valid.pkl"

# for eval data
split_datas_file = "./data/split_datas/v2x-sim-split-v2v.json"
