...
point_cloud_range_inf = [-51.2, -51.2, -8.6, 51.2, 51.2, -0.6]
...
data_root = "./datasets/V2X-Sim-full-v2i-delay/"
info_root = "./data/infos/V2X-Sim-full-v2i-delay/"
ann_file_train = info_root + f"nuscenes_infos_temporal_train_v2i.pkl"
ann_file_val = info_root + f"nuscenes_infos_temporal_val_v2i.pkl"
ann_file_test = info_root + f"nuscenes_infos_temporal_val_v2i.pkl"

# for eval data
split_datas_file = "./data/split_datas/v2x-sim-split-v2i.json"
