...
dataset_type = "XETV2XSimDataset"
data_root = "./datasets/V2X-Sim-full-v2v-delay/"
info_root = "./data/infos/V2X-Sim-full-v2v-delay/"
ann_file_train = info_root + f"nuscenes_infos_temporal_train_v2v.pkl"
ann_file_val = info_root + f"nuscenes_infos_temporal_val_v2v.pkl"
ann_file_test = info_root + f"nuscenes_infos_temporal_val_v2v.pkl"
