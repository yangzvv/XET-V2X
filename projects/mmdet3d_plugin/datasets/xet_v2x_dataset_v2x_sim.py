...
class XETV2XSimDataset(NuScenesDataset):
    def __init__(
        self,
        queue_length=4,
        bev_size=(200, 200),
        ...
        class_range=None,
        new_range_100=False,
        pc_range_veh=[-51.2, -51.2, -3.0, 51.2, 51.2, 5.0],
        pc_range_inf=[-51.2, -51.2, -8.6, 51.2, 51.2, -0.6],
        *args,
        **kwargs
        ):
    ...
    def get_data_info(self, index):
        ...
        if self.modality['use_inf']: 
            timestamps.append(info["timestamp"])  # yzw: camera 5 lidar 2 需适配
        ...
        if self.modality['use_lidar']:
            ...
            if self.modality['use_inf']:
                ...
                viewpad_inf[2, 2] = 0
                viewpad_inf[2, 3] = 1
                pointcloud_path_inf = pointcloud_path_veh.replace("LIDAR_TOP_id_1", self.modality["coop_lidar_id"])  # yzw
