...
@PIPELINES.register_module()
class XETV2XObjectRangeFilterTrack(object):
...
@PIPELINES.register_module()
class XETV2XObjectNameFilterTrack(object):
...
@PIPELINES.register_module()
class XETV2XPointsRangeFilter(PointsRangeFilter):
    ...
    def __init__(self, point_cloud_range, point_cloud_range_inf):
        # super(XETV2XPointsRangeFilter, self).__init__()
        self.pcd_range = np.array(point_cloud_range, dtype=np.float32)
